...
void search(void)
{
	...
	cout << setw(30) << "In Search Function" << endl
		 ...
		 << setw(31) << "( N ) Search by name" << endl
		 << endl

		 << setw(29) << "( I ) Search by Id" << endl
		 << endl

		 << setw(38) << "( T ) Search by author name" << endl
		 << endl

		 << setw(35) << "( C ) Search by Category" << endl
		 << endl

		 << setw(46) << "( P ) Search by Publication Company" << endl
		 << endl

		 << setw(43) << "( Y ) Search by Publication Year" << endl
		 << endl
...
void sort(void)
{
	...
	cout << setw(27) << "In Sort Function" << endl
		 ...
		 << setw(40) << "( A ) Sort in Ascending Order" << endl
		 << endl

		 << setw(41) << "( D ) Sort in Descending Order" << endl
		 << endl
...
void sortas(void)
{
	...
	cout << setw(27) << "In Sort Function" << endl
		 ...
		 << setw(29) << "( N ) Sort by name" << endl
		 << endl

		 << setw(27) << "( I ) Sort by Id" << endl
		 << endl

		 << setw(36) << "( T ) Sort by author name" << endl
		 << endl

		 << setw(33) << "( C ) Sort by Category" << endl
		 << endl

		 << setw(44) << "( P ) Sort by Publication Company" << endl
		 << endl

		 << setw(41) << "( Y ) Sort by Publication Year" << endl
		 << endl
...
void modify(void)
{
	...
	cout << setw(29) << "In Modify Function" << endl
		 ...
		 << setw(31) << "( N ) Modify by name" << endl
		 << endl

		 << setw(29) << "( I ) Modify by Id" << endl
		 << endl

		 << setw(38) << "( T ) Modify by author name" << endl
		 << endl

		 << setw(35) << "( C ) Modify by Category" << endl
		 << endl

		 << setw(46) << "( P ) Modify by Publication Company" << endl
		 << endl

		 << setw(43) << "( Y ) Modify by Publication Year" << endl
		 << endl
